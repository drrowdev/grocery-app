-- Phase 15: drop trigram fuzzy from match_item
-- Trigram match (similarity > 0.6) was the source of repeated silent
-- cross-modifier and cross-category collisions ('10% maletkött' vs
-- '17% maletkött', 'raejuusto' vs 'rahka', etc.). The dict + OFF catalog
-- + alias system already covers the realistic typing variations. From
-- now on match_item only returns exact alias or canonical matches.
