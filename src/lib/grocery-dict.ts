...
export const GROCERY_DICT: DictEntry[] = [
  ...
  // Disposable tableware (kertakäyttöastiat / engångskärl) — household,
  // but each needs its own icon, not the 🧻 category fallback.
  { fi: "kertakäyttöhaarukat", sv: "engångsgafflar", category: "household", unit: "pkt", default_qty: 1,
    aliases: ["kertakäyttöhaarukat", "kertakäyttöhaarukka", "kertakäyttöhaarukkaa",
              "engångsgafflar", "engångsgaffel", "disposable forks", "plastic forks"] },
  { fi: "kertakäyttölusikat", sv: "engångsskedar", category: "household", unit: "pkt", default_qty: 1,
    aliases: ["kertakäyttölusikat", "kertakäyttölusikka", "kertakäyttölusikkaa",
              "engångsskedar", "engångssked", "disposable spoons", "plastic spoons"] },
  { fi: "kertakäyttöveitset", sv: "engångsknivar", category: "household", unit: "pkt", default_qty: 1,
    aliases: ["kertakäyttöveitset", "kertakäyttöveitsi", "engångsknivar", "engångskniv",
              "disposable knives", "plastic knives"] },
  { fi: "kertakäyttölasit", sv: "engångsglas", category: "household", unit: "pkt", default_qty: 1,
    aliases: ["kertakäyttölasit", "kertakäyttölasi", "kertakäyttömuki", "kertakäyttömukit",
              "muovimuki", "muovimukit", "engångsglas", "engångsmugg", "engångsmuggar",
              "disposable cups", "plastic cups", "paper cups"] },
  { fi: "kertakäyttölautaset", sv: "engångstallrikar", category: "household", unit: "pkt", default_qty: 1,
    aliases: ["kertakäyttölautaset", "kertakäyttölautanen", "pahvilautaset",
              "engångstallrikar", "engångstallrik", "papperstallrikar",
  ...
  // Plain "sriracha" (no flavour) is a hot sauce → canned. Flavoured/typed
  // variants like "orange sriracha" are deliberately NOT aliased here: they
  // must stay distinct items with their full name, so they fall through to
  // Claude (which keeps the name and still categorizes them as a sauce).
  { fi: "sriracha", sv: "sriracha", category: "canned", unit: "pkt", default_qty: 1,
    aliases: ["sriracha", "sriracha-kastike", "srirachakastike"] },
];
