...
export const GROCERY_DICT: DictEntry[] = [
  ...
  { fi: "maito", sv: "mjölk", category: "dairy", unit: "l", default_qty: 1,
    aliases: ["maito", "maitoa", "mjölk", "milk", "rasvaton maito", "kevytmaito", "täysmaito", "kulutusmaito", "lättmjölk", "fettfri mjölk"] },
  ...
  { fi: "kanan sisäfilee", sv: "kycklinginnerfilé", category: "meat", unit: "pkt", default_qty: 1,
    aliases: ["kanan sisäfile", "kanan sisäfilee", "broilerin sisäfilee", "broilerin sisäfile", "sisäfilee", "sisäfile",
              "kycklinginnerfilé", "kyckling innerfilé", "kycklingens innerfilé", "innerfilé", "inre filé", "inre file", "inrefilé",
              "höna inre file", "höna inre filé", "höna inrefilé", "chicken tenderloin", "chicken inner fillet"] },
  { fi: "kanan ulkofilee", sv: "kycklingytterfilé", category: "meat", unit: "pkt", default_qty: 1,
    aliases: ["kanan ulkofile", "kanan ulkofilee", "broilerin ulkofilee", "broilerin ulkofile", "ulkofilee", "ulkofile",
              "kycklingytterfilé", "kyckling ytterfilé", "kycklingens ytterfilé", "ytterfilé", "yttre filé", "chicken breast"] },
